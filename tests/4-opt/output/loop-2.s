...
# br label %label36
	...
	b .main_label36
.main_label0:
# %op1 = phi i32 [ %op32, %label31 ], [ %op37, %label36 ]
# %op2 = phi i32 [ %op8, %label31 ], [ undef, %label36 ]
...
# ret void
	...
	b main_exit
.main_label6:
# %op7 = phi i32 [ %op30, %label10 ], [ %op35, %label33 ]
# %op8 = phi i32 [ %op29, %label10 ], [ %op34, %label33 ]
...
# br label %label0
	...
	b .main_label0
.main_label33:
# %op34 = phi i32 [ %op2, %label4 ]
# %op35 = phi i32 [ 0, %label4 ]
# br label %label6
	ld.w $a0, $fp, -50
	st.w $a0, $fp, -29
	ld.w $a0, $fp, -46
